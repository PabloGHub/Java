...
public class Avioneta extends Aeronave implements Propulsor
{
    ...
    public Avioneta(LocalDate _Entrega, Integer _Capacidad, Integer _HorasPrevistas, Integer _HorasEmpleadas, String _LineaMontaje, Double _Coste, Double _Precio, String _Propul)
    {
