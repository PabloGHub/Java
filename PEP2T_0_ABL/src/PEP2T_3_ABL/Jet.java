...
public class Jet extends Aeronave implements Propulsor 
{
    ...
    public Jet(LocalDate _Entrega, Integer _Capacidad, Integer _HorasPrevistas, Integer _HorasEmpleadas, String _LineaMontaje, Double _Coste, Double _Precio, String _Propul)
    {
